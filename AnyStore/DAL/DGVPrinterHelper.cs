...
namespace DGVPrinterHelper //AllocationRequest
{
    ...
    public static class Extensions
    {
            ...
            Graphics g, int pagewidth, int pageheight, Margins margins)
        {
            foreach (T t in list)
            {
                if (t is DGVPrinterHelper.ImbeddedImage)
                {
                    DGVPrinterHelper.ImbeddedImage ii = (DGVPrinterHelper.ImbeddedImage)Convert.ChangeType(t, typeof(DGVPrinterHelper.ImbeddedImage));
